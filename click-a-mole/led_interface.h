...
public:
  ...
  bool update_leaderboard_entry(int encoder_delta, bool btn_pressed);
...
private:
  ...
  int difficulty_hovered_index = 0; // 0-2 for Easy, Medium, Hard
  ...
  // Everyting for refactored roatry encoder code
#define output_A 2
#define output_B 3
  ...
  unsigned long last_debounce_ms = 0;// rotary
