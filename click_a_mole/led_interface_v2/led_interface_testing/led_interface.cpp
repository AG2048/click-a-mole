...
void DisplayInterface::end_mole(int mole_id, bool is_timeout, bool is_hp_zero){
    ...
    if (is_timeout){
        queue_animation(LedType::Ring, AnimationCategory::Solid, mole_id, start_time_ms, 200, -1, -1, nullptr, Colour::Red);
        queue_animation(LedType::Linear, AnimationCategory::Solid, mole_id, start_time_ms, 200, -1, -1, nullptr, Colour::Red);
        ...
        //but keep in mind
        queue_animation(LedType::Ring, AnimationCategory::Solid, mole_id, start_time_ms, 200, -1, -1, nullptr, Colour::Green);
        queue_animation(LedType::Linear, AnimationCategory::Solid, mole_id, start_time_ms, 200, -1, -1, nullptr, Colour::Green);
    }
}
