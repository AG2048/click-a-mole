...
// static const uint8_t SEG_S = 0x6D; 
// static const uint8_t SEG_E = 0x79;

// static const uint8_t SEG_L = 0x38;
// static const uint8_t SEG_U = 0x3E;
// static const uint8_t SEG_1 = 0x06;
// static const uint8_t SEG_N = 0x54;

// *************************************
// Const for OLED Display
// *************************************

// 'Diglett pokemon', 780x780px


// Array of all bitmaps for convenience. (Total bytes used to store images in PROGMEM = 76464)
// const int epd_bitmap_allArray_LEN = 1;
// const unsigned char* epd_bitmap_allArray[1] = {
// 	epd_bitmap_Diglett_pokemon
// };
...
DisplayInterface::DisplayInterface(
    ...
    // Wire.begin();
    // sevenSeg.begin(0x75);
    // // sevenSeg.setBrightness(10);   // 0..15
    // sevenSeg.clear();
    // sevenSeg.writeDisplay();
...
//     if (result == "WIN"){
//         write4(SEG_L, SEG_U, SEG_1, SEG_N);   // LU1N
//     } else if (result == "LOSE"){
//         write4(SEG_L, SEG_O, SEG_S, SEG_E);   // LOSE
//     } else {
//         return;
//     }
...
//     display.println("Click-A-Mole!");

// 	// Draw Diglett bitmap at center
// 	int x = (SCREEN_WIDTH - 16) / 2;
// 	int y = (SCREEN_HEIGHT - 16) / 2 + 10;
// 	oled.drawBitmap(x, y, epd_bitmap_Diglett_pokemon, 16, 16, SSD1306_WHITE);
//     display.display();
// }
